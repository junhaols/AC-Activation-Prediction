...
# boxplot with sig
# Optional dependencies - commented out to avoid import errors
...
def plot_cmp_pairs(df, pairs, y, x, figtitle, ttest_type, figsize = (16,12), xlabel = None, ylabel = None, types_order = None, hu = None, hu_order = None, save_fig = None):
