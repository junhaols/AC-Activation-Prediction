# Fig 3B: ridge plots of prediction-score distributions across all task contrasts
# (own correlation; 3 variants: simple / optimized / grouped-by-domain).
library(tidyverse)
library(ggridges)
library(hrbrthemes)
library(viridis)
...
data_file <- file.path(DATA_DIR, "AllTaskCons-OwnCorr.csv")
